...
function setBotResponse(response, quantity = false) {
  ...
  setTimeout(function () {
    ...
    if (response.length < 1) {
      ...
      var BotResponse =
        '<img class="botAvatar" src="./static/img/logo2.png"/><p class="botMsg">' +
        fallbackMsg +
        '</p><div class="clearfix"></div>';
...
function showBotTyping() {
  var botTyping =
    '<img class="botAvatar" id="botAvatar" src="./static/img/logo.jpg"/><div class="botTyping">' +
...
function backButtons(textToAdd) {
  ...
  setTimeout(function () {
    ...
    let BotResponse = `
      <div>
        <img class="botAvatar" src="./static/img/logo.jpg" />
